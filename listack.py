...
def main_loop(commands_in, debug, verbose):
    ...
    try:
        while ls.future and running:
            ...
            if breaking:
                if current == "_end_loop_":
                    breaking = False
                continue

            if continuing:
                if current == "_begin_loop_" or current == "_end_loop_":
                    continuing = False
                continue
...
# basic control flow
            ...
            elif current == "_begin_loop_":    # tag for cont and break
                pass

            elif current == "_end_loop_":   # tag for break
                pass
