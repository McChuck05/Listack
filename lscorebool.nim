...
core["some?"] = CoreVars(count:1)   # checks the validity and preserves the former TOS
proc doSomeQ*(env: var Environment) =
  env.past[^1].addLast(newBoolNode(not(env.past[^1][^1].invalid)))
core["some?"].variant.add(CoreObj(args: @["Any"], cmd: doSomeQ))
...
proc doCollQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in collTypes))
  setInvalid(env, invalid)
...
proc doItemQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in itemTypes))
  setInvalid(env, invalid)
...
proc doNumQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in numTypes))
  setInvalid(env, invalid)
...
proc doAlphaQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in alphaTypes))
  setInvalid(env, invalid)
...
proc doAlphaNumQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in alphanumTypes))
  setInvalid(env, invalid)
...
proc doWordyQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in wordyTypes))
  setInvalid(env, invalid)
...
proc doBlockyQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in blockyTypes))
  setInvalid(env, invalid)
...
proc doListyQ*(env: var Environment) =
  var invalid = checkInvalid(env, 1)
  env.past[^1].addLast(newBoolNode(env.past[^1][^1].nodeType in listyTypes))
  setInvalid(env, invalid)
