...
[1 2 3 4 5] each {dup .print sp 4 .= iff break} cr dump clear
[1 2 3 4 5] apply_each [{dup 4 .= iff (drop cont) dup .print = 5 if cr sp}{dup .print sp 3 .= if break}]
cr dump clear

[1 2 3 4 5] {.first* dup .print sp} until {4 .=}
cr dump clear
[1 2 3 4 5] {.first* dup .print sp break} until {4 .=}
cr dump clear
