...
# nop
    ...
    def do_case(self):  # object [[{cond1}{body1}][{cond2}{body2}]...[True {default}]] .case        uses side stacks o, p
        ...
        self.meta_fut([0, 0, "[[{True}{drop}]] .concat push_p push_o {pop_p .len 0 .>} while { .extract_l swap push_p copy_o swap .delist drop \\ break .concat .iff} pop_o drop pop_p drop"])
    ...
    def do_match(self):  # object [[{cond1}{body1}][{cond2}{body2}]...[True {default}]] .case       uses side stacks o, p
        ...
        self.meta_fut([0, 0, "[[{dup}{nop}]] .concat push_p push_o {pop_p .len 0 .>} while { .extract_l swap push_p copy_o swap .delist drop \\ break .concat swap \\ .= .concat swap .iff} pop_o drop pop_p drop"])
